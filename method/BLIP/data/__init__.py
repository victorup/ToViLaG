...
from data.detox_dataset import detox_dataset
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    if dataset=='pretrain':
        ...
        train_dataset = detox_dataset(transform_train)
        # val_dataset = detox_dataset(transform_test, config['image_root'], config['ann_root'],'val')
        # test_dataset = detox_dataset(transform_test, config['image_root'], config['ann_root'],'test') 
